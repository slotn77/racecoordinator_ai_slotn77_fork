...
describe("UndoRedoControlsComponent", () => {
  ...
  beforeEach(async () => {
    mockManager = jasmine.createSpyObj("UndoManager", [
      "undo",
      "redo",
      "canUndo",
      "canRedo",
    ...
    await TestBed.configureTestingModule({
      imports: [UndoRedoControlsComponent, MockTranslatePipe],
    }).compileComponents();
  });
  ...
  it("should delegate undo to manager", async () => {
    Object.defineProperty(mockManager, "undoStackCount", {
      get: () => 1,
      configurable: true,
    });
    fixture.detectChanges();
  ...
  it("should delegate redo to manager", async () => {
    Object.defineProperty(mockManager, "redoStackCount", {
      get: () => 1,
      configurable: true,
    });
    fixture.detectChanges();
