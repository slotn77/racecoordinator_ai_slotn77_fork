...
public class ArduinoConfigTest {
  ...
  public void testGetPinMode() {
    assertEquals(
        ArduinoConfig.PinMode.READ,
        ArduinoConfig.getPinMode(PinBehavior.BEHAVIOR_CALL_BUTTON.getNumber()));
    assertEquals(
        ArduinoConfig.PinMode.WRITE,
        ArduinoConfig.getPinMode(PinBehavior.BEHAVIOR_RELAY.getNumber()));

    assertEquals(
        ArduinoConfig.PinMode.READ,
        ArduinoConfig.getPinMode(PinBehavior.BEHAVIOR_LAP_BASE.getNumber() + 0));
    assertEquals(
        ArduinoConfig.PinMode.READ,
    ...
    assertEquals(
        ArduinoConfig.PinMode.READ_ANALOG,
